...
<div class="bg-white rounded-4 shadow-sm p-4 mb-5">
    ...
    <div class="alert alert-primary rounded-4 mb-5" role="alert">
        <i class="fa-solid fa-pen-to-square me-2"></i> Ubah Data Data Penduduk
    </div>
    <!-- form ubah data -->
            ...
            <div class="col-xl-6">
                <div class="row g-0">
                    <div class="mb-3 col-xl-6 pe-xl-3">
                        ...
                        <input type="text" name="nomor_urutan" class="form-control" value="<?php echo $data['nomor_urutan']; ?>" readonly>
                    </div>

                    <div class="mb-3 col-xl-6 pe-xl-3">
                        <label class="form-label">Tanggal Terdaftar <span class="text-danger">*</span></label>
                        <input type="text" name="tanggal_terdaftar" class="form-control datepicker" autocomplete="off" value="<?php echo date('d-m-Y', strtotime($data['tanggal_terdaftar'])); ?>" required>
            ...
            <div class="col-xl-6">
                <div class="mb-3 ps-xl-3">
                    ...
                    <select name="penghasilan_perbulan" class="form-select" autocomplete="off" required>
                        <option value="<?php echo $data['penghasilan_perbulan']; ?>"><?php echo $data['penghasilan_perbulan']; ?></option>
...
<div class="mb-2 pe-xl-3">
    ...
    <textarea name="alamat_lengkap" rows="2" class="form-control" autocomplete="off" required><?php echo $data['alamat_lengkap']; ?></textarea>
    <div class="invalid-feedback">Alamat Lengkap tidak boleh kosong.</div>
</div>

<div class="mb-3 pe-xl-3">
    <label class="form-label">NIk <span class="text-danger">*</span></label>
    <input type="text" name="nik" class="form-control" autocomplete="off" value="<?php echo $data['nik']; ?>" required>
...
<div class="col-xl-6">
    <div class="mb-3 ps-xl-3">
        ...
        <div class="mt-4">
            <img id="preview_foto" src="images/<?php echo $data['dokumen_foto']; ?>" class="border border-2 img-fluid rounded-4 shadow-sm" alt="dokumen_foto" width="240" height="240">
        </div>
